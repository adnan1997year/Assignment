...
public class Quadrangle {
    ...
    public Mat warp(Mat src) {
        ...
        Imgproc.line(result, lines[TOP].get(-5000), lines[TOP].get(5000), new Scalar(200, 100, 100), 8);
        Imgproc.line(result, lines[RIGHT].get(-5000), lines[RIGHT].get(5000), new Scalar(0, 255, 0), 8);


        Imgproc.line(result, lines[BOTTOM].get(-5000), lines[BOTTOM].get(5000), new Scalar(255, 0, 0), 8);
        Imgproc.line(result, lines[LEFT].get(-5000), lines[LEFT].get(5000), new Scalar(0, 0, 255), 8);
        ...
        if (p != null) {
            Imgproc.circle(result, p, 30, new Scalar(0, 0, 255), 8);
        }
